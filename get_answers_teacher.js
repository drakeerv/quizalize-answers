...
const questions = document.getElementsByClassName("_34eL_");
let answers = {};

for (var i = 0; i < questions.length; i++) {
    question = questions[i].getElementsByClassName("_1NuvU")[0].innerText;
    answer = questions[i].getElementsByClassName("_1FFF-")[0].children[1].innerText;
